...
<script src="{{ asset('portal_assets') }}/assets/vendor/libs/jquery/jquery.js"></script>
<script src="{{ asset('portal_assets') }}/assets/vendor/libs/popper/popper.js"></script>
<script src="{{ asset('portal_assets') }}/assets/vendor/js/bootstrap.js"></script>
<script src="{{ asset('portal_assets') }}/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
<script src="{{ asset('portal_assets') }}/assets/vendor/libs/hammer/hammer.js"></script>
<script src="{{ asset('portal_assets') }}/assets/vendor/libs/i18n/i18n.js"></script>
