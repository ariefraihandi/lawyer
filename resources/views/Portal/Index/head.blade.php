<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('portal_assets') }}/assets/img/favicon/favicon.ico" />
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{ asset('portal_assets') }}/assets/vendor/fonts/boxicons.css" />
    <link rel="stylesheet" href="{{ asset('portal_assets') }}/assets/vendor/fonts/fontawesome.css" />
    <link rel="stylesheet" href="{{ asset('portal_assets') }}/assets/vendor/fonts/flag-icons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('portal_assets') }}/assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    ...
    <script src="{{ asset('portal_assets') }}/assets/vendor/js/template-customizer.js"></script>    
    <script src="{{ asset('portal_assets') }}/assets/js/config.js"></script>
  </head>